...
export const overtureCta = {
  primary: "Begin",
  /** Offered next to Begin. Not in the PRD, but nine chapters with no
   *  way out is a corridor, not an invitation. */
  secondary: "Skip to the last part",
  /** Shown small, under the buttons. */
  note: "Nothing here is asking you for anything. You can close the tab at any point and nothing breaks.",
};
