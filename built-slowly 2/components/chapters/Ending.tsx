          ...
          {closingLines.map((line, i) => (
            <motion.p
              ...
              className={
                ...
                i === 3 || i === 6
                  ? "font-display text-[clamp(2rem,5vw,3.4rem)] leading-[1.1] tracking-[-0.02em] text-romance"
            ...
            {!storyOpened ? (
              ...
              <AnimatePresence>
                <motion.div
                  ...
                  className="glass-romance max-w-2xl rounded-3xl p-8 sm:p-10"
                >
                  <p className="text-romance font-display text-[clamp(1.9rem,4.4vw,3rem)] leading-[1.06]">
