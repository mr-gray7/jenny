  ...
  return (
    ...
    >
      <ChapterInner>
        ...
        {/* ── Status ───────────────────────────────────────────────── */}
        <Reveal>
          <div className="glass mt-10 flex flex-wrap items-baseline gap-x-8 gap-y-3 rounded-3xl p-8 sm:p-10">
            <span className="label">{dashboardStatus.label}</span>
            <p className="text-ember-gradient font-display text-[clamp(2rem,5vw,3.4rem)] leading-[1.05]">
