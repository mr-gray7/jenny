      ...
      <ChapterInner>
        ...
        <ol ref={track} className="relative mt-20 max-w-2xl">
          ...
          <motion.div
            ...
            className="absolute bottom-3 left-[7px] top-3 w-px bg-gradient-to-b from-ember-400 via-ember-500 to-ember-600/30"
          />
              ...
              >
                <h3
                  className={`font-display text-[clamp(1.9rem,4vw,2.9rem)] leading-[1.08] tracking-[-0.015em] ${
                    beat.pivot ? "text-ember-gradient italic" : "text-porcelain"
                  }`}
                >
                  {beat.headline}
                </h3>
