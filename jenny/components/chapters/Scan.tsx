        ...
        <Reveal>
          <div className="glass relative mt-12 overflow-hidden rounded-3xl">
            ...
            <div className="relative border-b border-porcelain/8 px-6 py-4 sm:px-8">
              ...
              >
                {running ? status : done ? "Results below." : "Awaiting instruction."}
              </p>
            </div>
            ...
            <div className="px-6 py-7 sm:px-8">
              ...
              <AnimatePresence>
                {done && (
                  ...
                  >
                    <p className="text-ember-gradient font-display text-[clamp(1.8rem,4vw,2.8rem)] leading-[1.08]">
                      {scanResult.headline}
                    </p>
                    <p className="mt-2 font-display text-[clamp(1.3rem,2.6vw,1.8rem)] italic leading-snug text-porcelain-dim">
                      {scanResult.sub}
                    </p>
