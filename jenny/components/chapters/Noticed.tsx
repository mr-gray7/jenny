  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back */}
        <span
          className={`absolute inset-0 flex items-center rounded-2xl border border-ember-400/22 bg-gradient-to-br from-ember-600/12 to-ink-900/90 p-5 backdrop-blur-xl [backface-visibility:hidden] ${
            reduced
              ? isFlipped
                ? "opacity-100"
                : "opacity-0"
        ...
        >
          <span className="text-[14px] leading-relaxed text-ember-100/90">
            {card.back}
          </span>
        </span>
      </motion.div>
